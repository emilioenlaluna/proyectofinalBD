...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-secondary py-4">
    <div class="container">
      <a class="navbar-brand" href="{{ route('home.index') }}"><img src="{{ asset('/img/bbva.png') }}" height="40"  alt="">LoinMonde</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ms-auto">
          ...
          <a class="nav-link active" href="{{ route('cart.index') }}">Mi Carrito</a>
          ...
          @else
          <a class="nav-link active" href="{{ route('myaccount.orders') }}">Mis Ordenes Y Compras</a>
  ...
  <header class="masthead bg-primary text-white text-center py-4">
    <div class="container d-flex align-items-center flex-column">
      <h2>@yield('subtitle', 'Loin Monde - El metaverso de BBVA')</h2>
    </div>
  </header>
  <!-- header -->
